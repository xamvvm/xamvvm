...
namespace Xamvvm
{
    public abstract  class PFContentPage<TPageModel> : Xamarin.Forms.ContentPage, IBasePage<TPageModel>, INavigationInterceptors where TPageModel : class, IBasePageModel, new()
	{
