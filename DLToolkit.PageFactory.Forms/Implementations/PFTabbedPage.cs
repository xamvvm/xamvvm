...
{
    public abstract class PFTabbedPage<TPageModel> : Xamarin.Forms.TabbedPage, IBasePage<TPageModel>, IPageModelInitializer<TPageModel>, INavigationInterceptors where TPageModel : class, INotifyPropertyChanged
	{
