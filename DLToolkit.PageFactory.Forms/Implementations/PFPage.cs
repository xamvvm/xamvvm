...
{
    public abstract class PFPage<TPageModel> : Xamarin.Forms.Page, IBasePage<TPageModel>, IPageModelInitializer<TPageModel>, INavigationInterceptors where TPageModel : class, INotifyPropertyChanged
	{
