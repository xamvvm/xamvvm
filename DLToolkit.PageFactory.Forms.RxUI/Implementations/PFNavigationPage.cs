...
namespace DLToolkit.PageFactory
{
    ...
    public abstract class PFNavigationPage<TNavigationModel, TPageModel> : PFNavigationPage<TNavigationModel>, IBaseNavigationPage<TNavigationModel, TPageModel>, IBasePage<TNavigationModel>, IPageModelInitializer<TNavigationModel>, INavigationInterceptors
    ...
    public abstract class PFNavigationPage<TNavigationModel> : NavigationPage, IBaseNavigationPage<TNavigationModel>, IBasePage<TNavigationModel>, IPageModelInitializer<TNavigationModel>, INavigationInterceptors where TNavigationModel : class, INotifyPropertyChanged
	{
