...
{
    public abstract class PFCarouselPage<TPageModel> : Xamarin.Forms.CarouselPage, IBasePage<TPageModel>, IPageModelInitializer<TPageModel>, INavigationInterceptors where TPageModel : class, INotifyPropertyChanged
	{
