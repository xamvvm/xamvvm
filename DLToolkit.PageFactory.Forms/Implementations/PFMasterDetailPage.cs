...
{
    public abstract  class PFMasterDetailPage<TPageModel> : Xamarin.Forms.MasterDetailPage, IBasePageAll<TPageModel> where TPageModel : class, INotifyPropertyChanged
	{
